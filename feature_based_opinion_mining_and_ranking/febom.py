...
feature_based_opinion_mining_and_ranking based on the elsevier research paper
...
if __name__ == "__main__":
    ...
    # first we detect the language
    attr = language_detection(text)
    print "Original :",text
    print "Translated from %s : %s"%(attr[1],attr[0])
